...
export const profilePicturePath = writable(
    JSON.parse(localStorage.getItem("profilePicturePath")) || profilePictureDefault
);

profilePicturePath.subscribe((val) => localStorage.setItem("profilePicturePath", JSON.stringify(val)));
